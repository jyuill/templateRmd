...
## -- FOLDER: specify folder that blog post is in -> will have its own folder
blogfldr <- ""
## -- RMARKDOWN file to publish
blogfile <- paste0(blogfldr,"/<filename>.Rmd")
## -- BLOG TITLE
blogtitle <- "<catchy seo-friendly title>"
## -- NEW OR EDIT?
...
blogthumbnail <- "figure/<code-chunk-name>-1.png"
##############################################################################

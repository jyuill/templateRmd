...
* **basic - web components (fig4)**: basic template (no toc) with navbar and GTM tags, both of which need to be modified for the specific situation. 
...
3. New directory for markdown template: **inst > rmarkdown > templates > folder name for template > skeleton**
